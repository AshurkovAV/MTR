...
namespace Medical.DataCore.v10.E
{
    ...
    public class RegisterE : IRegister
    {

        #region Inner

        [XmlIgnore]
        public List<IRecord> InnerRecordCollection { 
            get { return _recordsCollection.Select(p => p as IRecord).ToList(); }
    ...
    public class RecordsE : IRecord
    {

        #region Inner

        [XmlIgnore]
        public List<IMEvent> InnerEventCollection {
            get { return _eventCollection.Select(p => p as IMEvent).ToList(); }
            set { _eventCollection = value.Select(p => p as EventE).ToList(); }
        }
        ...
        [XmlIgnore]
        public List<EventE> _eventCollection { get; set; }
        ...
        public List<EventE> EventCollection {
        ...
        public RecordsE()
        {
            _eventCollection = new List<EventE>();
        }
    }
