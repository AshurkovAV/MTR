...
namespace Medical.DataCore.v10.EAnswer
{
    ...
    public class RegisterEAnswer : IRegisterAnswer
    {
        #region Inner

        [XmlIgnore]
        public List<IRecordAnswer> InnerRecordCollection {
            get { return _recordsCollection.Select(p => p as IRecordAnswer).ToList(); }
    ...
    public class RecordsEAnswer : IRecordAnswer
    {
        #region Inner

        [XmlIgnore]
        public List<IMEventAnswer> InnerEventCollection {
            get { return _eventCollection.Select(p => p as IMEventAnswer).ToList(); }
            set { _eventCollection = value.Select(p => p as EventEAnswer).ToList(); }
        }
        ...
        [XmlIgnore]
        public List<EventEAnswer> _eventCollection { get; set; }
        #endregion
        ...
        public List<EventEAnswer> EventCollection {
        ...
        {
            _eventCollection = new List<EventEAnswer>();
        }
    }
