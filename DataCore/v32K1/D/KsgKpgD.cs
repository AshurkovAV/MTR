...
namespace Medical.DataCore.v32K1.D
{
    public class KsgKpgD : IKsgKpg
    {
        ...
        public string KoefZXml
        {
            get { return KoefZ.ToF8(); }
            set { KoefZ = value.ToDecimalNullable(); }
        }

        [XmlElement(ElementName = "KOEF_UP")]
        public string KoefUpXml
        {
            get { return KoefUp.ToF8(); }
            set { KoefUp = value.ToDecimalNullable(); }
        }
        [XmlElement(ElementName = "BZTSZ")]
        public decimal? BaseRate { get; set; }

        [XmlElement(ElementName = "KOEF_D")]
        public string KoefDXml
        {
            get { return KoefD.ToF8(); }
            set { KoefD = value.ToDecimalNullable(); }
        }
        [XmlElement(ElementName = "KOEF_U")]
        public string KoefUXml
        {
            get { return KoefU.ToF8(); }
            set { KoefU = value.ToDecimalNullable(); }
        }
