...
namespace Medical.DataCore.v30.E
{
    public class EventE: IZEvent
    {
        ...
        [XmlIgnore]
        public List<IDirectionOnkE> InnerDirectionOnkCollection { get; set; }
        [XmlIgnore]
        public List<IConsultationsOnk> InnerConsultationsOnkCollection { get; set; }
        [XmlIgnore]
        public IEventOnk InnerEventOnk { get; set; }
        [XmlIgnore]
