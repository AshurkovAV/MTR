...
namespace Medical.DataCore.v21K2.D
{
    ...
    public class AccountRegisterD
    {
        ...
        public List<RecordsCollection> RecordsCollection { get; set; }
    ...
    public class RecordsCollection
    {
        ...
        public List<EventD> EventCollection { get; set; }

        public RecordsCollection()
        {
            EventCollection = new List<EventD>();
        }
    }
