...
{
    public class PLinqMedicalEventList : IListSource
    {
        ...
        public PLinqMedicalEventList(IMedicineRepository repository, Expression<Func<EventShortView, bool>> predicate = null)
        {
