...
{
    public class CopyZPatientViewModel : ViewModelBase
    {
        ...
        private void Init()
        {
            ...
            if (Patient.AccountId.HasValue)
            {
                ...
                var meventResult = _repository.GetZslMeventsByPatientId(PatientId);
                if (meventResult.Success)
                {
                    MeventCollection = new ObservableCollection<ZslFactMedicalEvent>(meventResult.Data);
                }
            }
        }
        ...
        public ObservableCollection<ZslFactMedicalEvent> MeventCollection { get; set; }
        ...
        private void Copy()
        {
            var copyResult = _repository.CopyZPatientToAnotherTerritoryAccount(PatientId, 
