...
{
    public abstract class ZSlkoefModel : EditableObject<ZSlkoefModel>, IDataErrorInfo 
    {
        private static readonly ICacheRepository Repository;

        private AbstractValidator<ZSlkoefModel> _validator;
        public AbstractValidator<ZSlkoefModel> Validator => _validator ?? (_validator = new ZSlkoefValidator());

        public ZFactSlKoef Slkoef { get; set; }
        ...
        protected ZSlkoefModel(InitContext initContext)
        {
            Slkoef = (ZFactSlKoef)initContext.Parameters[0];
        }

        public ZFactSlKoef Update()
        {
            var tmp = Map.ObjectToObject<ZFactSlKoef>(Slkoef);
        ...
        public abstract int ZslKoefId { get; set; }
        public abstract int? ZksgKpgId { get; set; }
        public abstract int? NumberDifficultyTreatment { get; set; }
        public abstract decimal? ValueDifficultyTreatment { get; set; }
