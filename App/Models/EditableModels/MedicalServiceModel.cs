...
{
    public abstract class MedicalServiceModel : EditableObject<MedicalServiceModel>, IDataErrorInfo 
    {
        private AbstractValidator<MedicalServiceModel> _validator;
        public AbstractValidator<MedicalServiceModel> Validator
        {
            get { return _validator ?? (_validator = new MedicalServiceValidator()); }
        }
        public FactMedicalServices MedicalService { get; set; }
        // Any abstract property becomes editable.
        public abstract int MedicalServicesId { get; set; } // int(10)
        public abstract int MedicalEventId { get; set; } // int(10)
        ...
        protected MedicalServiceModel(InitContext initContext)
        {
            MedicalService = (FactMedicalServices)initContext.Parameters[0];
        }
        public FactMedicalServices Update()
        {
            var tmp = Map.ObjectToObject<FactMedicalServices>(MedicalService);
