...
{
    public abstract class RefusalModel : EditableObject<RefusalModel>, IDataErrorInfo 
    {
        private static readonly ICacheRepository Repository;

        private AbstractValidator<RefusalModel> _validator;
        public AbstractValidator<RefusalModel> Validator => _validator ?? (_validator = new RefusalValidator());
        ...
        public abstract RefusalType RefusalType { get; set; }
