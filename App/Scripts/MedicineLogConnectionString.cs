...
using Core;
namespace Medical.AppLayer.Scripts { public class MedicineLogConnectionString{ [Category("Основные настройки")][DisplayNameAttribute("Название")]public string Name { get; set; }
