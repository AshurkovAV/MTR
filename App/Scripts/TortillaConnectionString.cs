...
using Core;
namespace Medical.AppLayer.Scripts { public class TortillaConnectionString{ [Category("Основные настройки")][DisplayNameAttribute("Название")]public string Name { get; set; }
