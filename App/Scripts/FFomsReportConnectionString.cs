...
using Core;
namespace Medical.AppLayer.Scripts { public class FFomsReportConnectionString{ [Category("Основные настройки")][DisplayNameAttribute("Название")]public string Name { get; set; }
