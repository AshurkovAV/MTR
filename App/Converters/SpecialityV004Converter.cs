...
{
    public class SpecialityV004Converter : IValueConverter
    {
       private static readonly ICacheRepository Repository;

       static SpecialityV004Converter()
        {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                return "{0} {1}".F(value, Repository.Get(CacheRepository.V004Cache).GetString(value.ToInt32Nullable()));
            }
