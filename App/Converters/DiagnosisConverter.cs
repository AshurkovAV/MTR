...
{
    public class DiagnosisConverter : IValueConverter
    {
        private static readonly ICacheRepository Repository;

        static DiagnosisConverter()
        {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                return Repository.Get(CacheRepository.IDC10Cache).GetString(value.ToInt32Nullable());
            }
