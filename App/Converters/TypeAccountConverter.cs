...
{
    /// <summary>
    /// Конвертер типа счета
    /// </summary>
    public class TypeAccountConverter : IValueConverter
    {
         private static readonly ICacheRepository Repository;

         static TypeAccountConverter()
        {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                return Repository.Get("AccountTypeCache").GetString(value.ToInt32Nullable());
            }
            return value;
        }
