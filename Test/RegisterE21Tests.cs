...
namespace Test
{
    ...
    /// </summary>
    [TestClass]
    public class RegisterE21Tests
    {
        public RegisterE21Tests()
        {
        ...
        public void TestSerializeE()
        {
            ...
            using (Stream stream = assembly.GetManifestResourceStream("DataTests.Data.RegisterE21.xml"))
            {
        ...
        [TestMethod]
        public void TestValidateE()
        {
            /*LoaderBase loader = new LoaderE();
            string solution_dir = Path.GetDirectoryName(Path.GetDirectoryName(TestContext.TestDir));
            loader.Validate<RegisterE>(new XmlTextReader(solution_dir + "\\DataTests\\Data\\RegisterE21.xml"), "Medical.DataCore.v21.Xsd.E2.xsd");
